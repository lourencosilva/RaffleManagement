...
class PrizesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create prize" do
    assert_difference('Prize.count') do
      post prizes_url, params: { prize: { description: @prize.description, placing: @prize.placing, ticket_id: @prize.ticket_id, user_id: @prize.user_id } }
    end
  ...
  test "should update prize" do
    patch prize_url(@prize), params: { prize: { description: @prize.description, placing: @prize.placing, ticket_id: @prize.ticket_id, user_id: @prize.user_id } }
